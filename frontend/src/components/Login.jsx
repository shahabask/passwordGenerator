...
const Login = () => {
  ...
  return (
    <div className='h-5/6 flex justify-center'>
        <div className='md:w-2/6 h-fit bg-sky-900 rounded-lg mt-20'>
            ...
            <form className='p-5' onSubmit={submitHandler}>
                ...
                <button type="submit" className='bg-gray-700 hover:bg-gray-800 px-3 py-1 rounded-lg text-white border-primaryColor font-medium'>Login</button>
                  <Link to='/register'><h6 className='text-white hover:underline'>Register</h6></Link>
                </div>
            </form>
        </div>
    </div>
